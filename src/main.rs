...
fn main() {
    ...
    match day {
        ...
        11 => solve!(solutions::day11, input.as_ref().unwrap().clone()),
        12 => solve!(solutions::day12, input.as_ref().unwrap().clone()),
        13 => solve!(solutions::day13, input.as_ref().unwrap().clone()),
